...
func main() {
	...
	listCandidatesUC := usecase.NewListCandidates(matchRepo, profileClient, slotClient, courseClient, candidateStore, reputation, friendships)
	sendRequestUC := usecase.NewSendMatchRequest(matchRepo, profileClient)
