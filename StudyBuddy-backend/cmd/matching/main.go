...
func main() {
	...
	embeddingStore := repository.NewPgEmbeddingStore(pool)
	...
	listCandidatesUC := usecase.NewListCandidates(matchRepo, profileClient, slotClient, courseClient, candidateStore, embeddingStore, reputation, friendships)
